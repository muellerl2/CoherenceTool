...
def writehead(f, run, observatory, weeks, line, source):
    ...
    f.write('          <em>- Definition of significance coherence: the distribution is modeled with a normal distribution clipped at 0. A significant coherence is defined as<br> ')
